        ...
        (function(global) {
            var e = require("cannon-es"),
                ...
                n = function() {
                    ...
                    function l() { this.head = null, this.tail = null }
                    return Object.assign(a.prototype, {
                        setFromPoints: function(e) {!0 !== Array.isArray(e) && console.error("THREE.ConvexHull: Points parameter is not an array."), e.length < 4 && console.error("THREE.ConvexHull: The algorithm needs at least four points."), this.makeEmpty(); for (var t = 0, n = e.length; t < n; t++) this.vertices.push(new h(e[t])); return this.compute(), this },
                        setFromObject: function(e) {
                            var n = [];
                            return e.updateMatrixWorld(!0), e.traverse(function(e) {
                                var r, i, o, a = e.geometry;
                                if (void 0 !== a)
                                    if (a.isGeometry) { var s = a.vertices; for (r = 0, i = s.length; r < i; r++)(o = s[r].clone()).applyMatrix4(e.matrixWorld), n.push(o) } else if (a.isBufferGeometry) {
                                    var u = a.attributes.position;
                                    if (void 0 !== u)
                                        for (r = 0, i = u.count; r < i; r++)(o = new t.Vector3).fromBufferAttribute(u, r).applyMatrix4(e.matrixWorld), n.push(o)
                                }
                        ...
                        intersectRay: function(e, t) {
                            for (var n = this.faces, r = -Infinity, i = Infinity, o = 0, a = n.length; o < a; o++) {
                                var s = n[o],
                                    u = s.distanceToPoint(e.origin),
                                    h = s.normal.dot(e.direction);
                                if (u > 0 && h >= 0) return null;
                                var l = 0 !== h ? -u / h : 0;
                                if (!(l <= 0) && (h > 0 ? i = Math.min(l, i) : r = Math.max(l, r), r > i)) return null
                            }
                            return e.at(-Infinity !== r ? r : i, t), t
                        },
                        intersectsRay: function(e) { return null !== this.intersectRay(e, o) },
                        makeEmpty: function() { return this.faces = [], this.vertices = [], this },
                        addVertexToFace: function(e, t) { return e.face = t, null === t.outside ? this.assigned.append(e) : this.assigned.insertBefore(t.outside, e), t.outside = e, this },
                        removeVertexFromFace: function(e, t) { return e === t.outside && (t.outside = null !== e.next && e.next.face === t ? e.next : null), this.assigned.remove(e), this },
                        removeAllVerticesFromFace: function(e) { if (null !== e.outside) { for (var t = e.outside, n = e.outside; null !== n.next && n.next.face === e;) n = n.next; return this.assigned.removeSubList(t, n), t.prev = n.next = null, e.outside = null, t } },
                        ...
                        resolveUnassignedPoints: function(e) {
                            if (!1 === this.unassigned.isEmpty()) {
                                ...
                                do {
                                    for (var n = t.next, r = this.tolerance, i = null, o = 0; o < e.length; o++) { var a = e[o]; if (0 === a.mark) { var s = a.distanceToPoint(t.point); if (s > r && (r = s, i = a), r > 1e3 * this.tolerance) break } }
                        ...
                        computeExtremes: function() {
                            ...
                            for (i.copy(this.vertices[0].point), o.copy(this.vertices[0].point), e = 0, n = this.vertices.length; e < n; e++) {
                                var u = this.vertices[e],
                                    h = u.point;
                                for (r = 0; r < 3; r++) h.getComponent(r) < i.getComponent(r) && (i.setComponent(r, h.getComponent(r)), a[r] = u);
                                for (r = 0; r < 3; r++) h.getComponent(r) > o.getComponent(r) && (o.setComponent(r, h.getComponent(r)), s[r] = u)
                            }
                            return this.tolerance = 3 * Number.EPSILON * (Math.max(Math.abs(i.x), Math.abs(o.x)) + Math.max(Math.abs(i.y), Math.abs(o.y)) + Math.max(Math.abs(i.z), Math.abs(o.z))), { min: a, max: s }
                        },
                        computeInitialHull: function() {
                            void 0 === e && (e = new t.Line3, n = new t.Plane, r = new t.Vector3);
                            var i, o, a, u, h, l, c, d, m, p = this.vertices,
                                f = this.computeExtremes(),
                                v = f.min,
                                g = f.max,
                                x = 0,
                                y = 0;
                            for (l = 0; l < 3; l++)(m = g[l].point.getComponent(l) - v[l].point.getComponent(l)) > x && (x = m, y = l);
                            for (x = 0, e.set((o = v[y]).point, (a = g[y]).point), l = 0, c = this.vertices.length; l < c; l++)(i = p[l]) !== o && i !== a && (e.closestPointToPoint(i.point, !0, r), (m = r.distanceToSquared(i.point)) > x && (x = m, u = i));
                            for (x = -1, n.setFromCoplanarPoints(o.point, a.point, u.point), l = 0, c = this.vertices.length; l < c; l++)(i = p[l]) !== o && i !== a && i !== u && (m = Math.abs(n.distanceToPoint(i.point))) > x && (x = m, h = i);
                            var w = [];
                            if (n.distanceToPoint(h.point) < 0)
                                ...
                                for (w.push(s.create(o, u, a), s.create(h, o, a), s.create(h, a, u), s.create(h, u, o)), l = 0; l < 3; l++) d = (l + 1) % 3, w[l + 1].getEdge(2).setTwin(w[0].getEdge((3 - l) % 3)), w[l + 1].getEdge(0).setTwin(w[d + 1].getEdge(1));
                            for (l = 0; l < 4; l++) this.faces.push(w[l]);
                            for (l = 0, c = p.length; l < c; l++)
                                if ((i = p[l]) !== o && i !== a && i !== u && i !== h) {
                                    x = this.tolerance;
                                    var T = null;
                                    for (d = 0; d < 4; d++)(m = this.faces[d].distanceToPoint(i.point)) > x && (x = m, T = this.faces[d]);
                        ...
                        computeHorizon: function(e, t, n, r) {
                            ...
                            do {
                                var o = i.twin,
                                    a = o.face;
                                0 === a.mark && (a.distanceToPoint(e) > this.tolerance ? this.computeHorizon(e, o, a, r) : r.push(i)), i = i.next
                            } while (i !== t);
                            return this
                        },
                        addAdjoiningFace: function(e, t) { var n = s.create(e, t.tail(), t.head()); return this.faces.push(n), n.getEdge(-1).setTwin(t.twin), n.getEdge(0) },
                        ...
                        addVertexToHull: function(e) { var t = []; return this.unassigned.clear(), this.removeVertexFromFace(e, e.face), this.computeHorizon(e.point, null, e.face, t), this.addNewFaces(e, t), this.resolveUnassignedPoints(this.newFaces), this },
                        cleanup: function() { return this.assigned.clear(), this.unassigned.clear(), this.newFaces = [], this },
                        compute: function() { var e; for (this.computeInitialHull(); void 0 !== (e = this.nextVertexToAdd());) this.addVertexToHull(e); return this.reindexFaces(), this.cleanup(), this }
                    }), Object.assign(s, {
                        create: function(e, t, n) {
                            var r = new s,
                                ...
                                o = new u(t, r),
                                a = new u(n, r);
                            return i.next = a.prev = o, o.next = i.prev = a, a.next = o.prev = i, r.edge = i, r.compute()
                        }
                    }), Object.assign(s.prototype, {
                        getEdge: function(e) { for (var t = this.edge; e > 0;) t = t.next, e--; for (; e < 0;) t = t.prev, e++; return t },
                        compute: function() {
                        ...
                        head: function() { return this.vertex },
                        tail: function() { return this.prev ? this.prev.vertex : null },
                        length: function() {
                            var e = this.head(),
                                t = this.tail();
                        ...
                        setTwin: function(e) { return this.twin = e, e.twin = this, this }
                ...
                o = function(o, l) {
                    ...
                    if (l.type === i.CYLINDER) return function(n, i) {
                        ...
                        return c._type = e.Shape.types.CYLINDER, c.radiusTop = l, c.radiusBottom = l, c.height = h, c.numSegments = 12, c.orientation = new e.Quaternion, c.orientation.setFromEuler("y" === a ? r : 0, "z" === a ? r : 0, 0, "XYZ").normalize(), c
                    }(o, l);
                    if (l.type === i.SPHERE) return function(t, n) { if (n.sphereRadius) return new e.Sphere(n.sphereRadius); var r = u(t); return r ? (r.computeBoundingSphere(), new e.Sphere(r.boundingSphere.radius)) : null }(o, l);
                    if (l.type === i.HULL) return function(r) {
                        var i = u(r);
                        if (!i || !i.vertices.length) return null;
                        for (var o = 0; o < i.vertices.length; o++) i.vertices[o].x += 1e-4 * (Math.random() - .5), i.vertices[o].y += 1e-4 * (Math.random() - .5), i.vertices[o].z += 1e-4 * (Math.random() - .5);
                        ...
                        for (o = 0; o < a.length; o++) {
                            ...
                            do {
                                var d = c.head().point;
                                s.push(new e.Vec3(d.x, d.y, d.z)), h.push(new e.Vec3(l.normal.x, l.normal.y, l.normal.z)), c = c.next
                            } while (c !== l.edge)
                        }
                        return new e.ConvexPolyhedron({ vertices: s, normals: h })
                    }(o);
                    if (l.type === i.MESH) return (c = u(o)) ? function(t) { var n = h(t); if (!n.length) return null; var r = Object.keys(n).map(Number); return new e.Trimesh(n, r) }(c) : null;
                    ...
                    switch (c.metadata ? c.metadata.type : c.type) {
                        ...
                        case "CylinderBufferGeometry":
                            return function(n) {
                                ...
                                return i._type = e.Shape.types.CYLINDER, i.radiusTop = r.radiusTop, i.radiusBottom = r.radiusBottom, i.height = r.height, i.numSegments = r.radialSegments, i.orientation = new e.Quaternion, i.orientation.setFromEuler(t.Math.degToRad(-90), 0, 0, "XYZ").normalize(), i
                            }(c);
                        case "PlaneGeometry":
            ...
            function u(e) {
                var n, r = function(e) { var t = []; return e.traverse(function(e) { "Mesh" === e.type && t.push(e) }), t }(e),
                    i = new t.Geometry,
                    o = new t.Geometry;
                ...
                if (1 === r.length) {
                    var a = new t.Vector3,
                        s = new t.Quaternion,
                        u = new t.Vector3;
                    return r[0].geometry.isBufferGeometry ? r[0].geometry.attributes.position && r[0].geometry.attributes.position.itemSize > 2 && i.fromBufferGeometry(r[0].geometry) : i = r[0].geometry.clone(), i.metadata = r[0].geometry.metadata, r[0].updateMatrixWorld(), r[0].matrixWorld.decompose(a, s, u), i.scale(u.x, u.y, u.z)
                }
                for (; n = r.pop();)
                    if (n.updateMatrixWorld(), n.geometry.isBufferGeometry) {
                        if (n.geometry.attributes.position && n.geometry.attributes.position.itemSize > 2) {
                            ...
                            h.fromBufferGeometry(n.geometry), o.merge(h, n.matrixWorld), h.dispose()
                        }
        ...
        let AmmoBody = {
            ...
            initBody: (function() {
                ...
                return function() {
                    ...
                    this.rbInfo.m_friction = data.friction;
